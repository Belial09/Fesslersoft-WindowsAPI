...
{
    /// <summary>
    /// Contains information about the session, including name of the computer; name of the user; open files, pipes, and devices on the computer; and the name of the transport the client is using. Descriptions taken from https://msdn.microsoft.com/en-us/library/windows/desktop/bb525401(v=vs.85).aspx (SESSION_INFO_502 structure).
    /// </summary>
