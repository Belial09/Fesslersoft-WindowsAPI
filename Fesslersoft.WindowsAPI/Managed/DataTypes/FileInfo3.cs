...
{
    /// <summary>
    /// Contains the identification number and other pertinent information about files, devices, and pipes. Descriptions taken from https://msdn.microsoft.com/en-us/library/windows/desktop/bb525375(v=vs.85).aspx (FILE_INFO_3 structure).
    /// </summary>
    public sealed class FileInfo3
    {
        ...
        /// <summary>
        /// Pointer to a string that specifies the path of the opened resource. This string is Unicode if _WIN32_WINNT or FORCE_UNICODE are defined.
        /// </summary>
        /// <value>
        /// The path.
        /// </value>
        ...
        internal static FileInfo3 MapToFileInfo3(Structs.FileInfo3 fileInfo)
        {
            return new FileInfo3
            {
                ...
                Permission = (Helpers.Enum.SharePermissions)fileInfo.Permission,
