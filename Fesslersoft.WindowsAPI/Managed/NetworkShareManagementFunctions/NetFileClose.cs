...
namespace Fesslersoft.WindowsAPI.Managed.NetworkShareManagementFunctions
{
    ...
    public sealed class NetFileClose
    {
        ...
        /// </summary>
        /// <param name="servername">Pointer to a string that specifies the DNS or NetBIOS name of the remote server on which the function is to execute. If this parameter is NULL, the local computer is used. This string is Unicode if _WIN32_WINNT or FORCE_UNICODE is defined.</param>
        /// <param name="id">Specifies the file identifier of the opened resource instance to close.</param>
        /// <returns>If the function succeeds, the return value is NERR_Success. If the function fails, the return value can be one of the following error codes. ERROR_ACCESS_DENIED or ERROR_FILE_NOT_FOUND</returns>
        public static Enum.NetApiResult CloseFile(string servername, int id)
        {
